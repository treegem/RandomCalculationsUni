...
def main():
    path = '//file/e24/Projects/ReinhardLab/data_setup_nv1/180508_deer_2d_plot/deer_2d_plot'
    ...
    plt.imshow(differences, extent=[taus[0], taus[-1], 155, 20000], origin='lower', aspect=0.25)
    plt.xlabel('tau in sequence (ns)')
    plt.ylabel('tau between sequences (ns)')
    plt.colorbar()
    plt.savefig('ramsey_correlation_with_pi.png', dpi=300)

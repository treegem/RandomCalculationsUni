...
def main():
    path_res = '//nas.ads.mwn.de/TUZE/wsi/e24/ReinhardLab/data_setup_nv1/180704_hf_setup_deer_tests/' \
    ...
    path_nonres = '//nas.ads.mwn.de/TUZE/wsi/e24/ReinhardLab/data_setup_nv1/180704_hf_setup_deer_tests'

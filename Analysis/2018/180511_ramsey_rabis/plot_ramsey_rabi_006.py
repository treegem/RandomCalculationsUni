...
def main():
    path = '//nas.ads.mwn.de/TUZE/wsi/e24/ReinhardLab/data_setup_nv1/180511_ramsey_correlations_rabi/' \
           '006_ramsey_corr_rabi'
    ...
    plt.savefig('ramsey_rabi_006.png', dpi=300)

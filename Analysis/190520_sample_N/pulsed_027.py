...
def main():
    path = '//nas.ads.mwn.de/TUZE/wsi/e24/ReinhardLab/data_setup_nv1/190520_sample_N'
    fname = 'pulsed.027.mat'
    ...
    if not os.path.isfile(current_file):
        ...
        integrate_current(
            fname='//nas.ads.mwn.de/TUZE/wsi/e24/ReinhardLab/data_setup_nv1/190520_sample_N/analogue_027/analogue_data_ch1.txt',
            sweeps=4,

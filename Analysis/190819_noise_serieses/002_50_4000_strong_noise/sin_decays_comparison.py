...
def main():
    ...
    popt_qff, _ = curve_fit(stretched, xdata=xs, ydata=qff, p0=[1, 1.5, 1, 0],
                            bounds=[[0, 1., 0.8, 0], [15, 2., 1.2, 0.2]])
    popt_tau, _ = curve_fit(stretched, xdata=xs, ydata=tau, p0=[1, 1.5, 1, 0],
                            bounds=[[0, 1., 0.8, 0], [15, 2., 1.2, 0.2]])

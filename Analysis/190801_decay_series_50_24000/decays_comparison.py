...
def main():
    ...
    popt_qff, _ = curve_fit(stretched, xdata=xs, ydata=qff, p0=[1, 2.1, 1], bounds=[[0, 0.1, 0.8], [2, 2.5, 1.2]])
    popt_tau, _ = curve_fit(stretched, xdata=xs, ydata=tau, p0=[1, 2.1, 1], bounds=[[0, 0.1, 0.8], [2, 2.5, 1.2]])
